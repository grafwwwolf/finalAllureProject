package ru.pigarev.framework.utils;
...
public class PropConst {
    ...
    public static final String RUB_CURRENCY = "Рубли";

    public static final String RUB_CURRENCY_ABB = "RUB";

    public static final String USD_CURRENCY = "Доллары США";

    public static final String USD_CURRENCY_ABB = "USD";
}
